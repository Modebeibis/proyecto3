...
Se crearon ```seeders``` que nos permiten poblar la base de datos para probar que su funcionamiento fuera el indicado. Para esto es necesario que la BDD ya hubiese sido creada y migrada.
```bash
