...
urlpatterns = [
    ...
    path('<int:author_id>/eliminar/autor/', views.DeleteAuthor.as_view(),name='delete_authors'),
    path('<int:member_id>/eliminar/miembro/', views.DeleteMember.as_view(),name='delete_members'),
